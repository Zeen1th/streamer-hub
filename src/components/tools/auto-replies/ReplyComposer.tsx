  ...
  return (
    <div>
      <textarea
        ...
        className="min-h-24 w-full resize-y whitespace-pre-wrap border border-ink/25 bg-surface-2 px-3 py-3 font-mono text-sm text-ink outline-none placeholder:text-ink/50 focus:border-primary focus:ring-2 focus:ring-primary/25"
      />
      <div className="mt-3 flex flex-wrap gap-2">
        {tokens.map((item) => (
          <button
            ...
            className="border border-ink/25 bg-surface px-3 py-2 text-start font-sans text-xs font-bold text-ink hover:border-primary hover:bg-primary/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
