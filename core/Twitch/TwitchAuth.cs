...
public static class TwitchConstants
{
    ...
    public const string Scopes = "chat:read chat:edit channel:manage:broadcast channel:read:redemptions moderator:manage:banned_users channel:manage:moderators channel:manage:vips moderator:manage:chat_messages moderation:read moderator:manage:shoutouts moderator:read:followers";
